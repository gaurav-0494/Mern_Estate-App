...
function CreateListing() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (+formData.regularPrice < +formData.discountPrice) return setError('Discoutn price must be lower then regular price');
            ...
            <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
                <div className='flex flex-col gap-4 flex-1'>
                    ...
                    <div className='flex flex-wrap gap-6'>
                        ...
                        <div className='flex items-center gap-2'>
                            <input type='number' id='regularprice' min='50' max='10000000' required className='p-3 border border-gray-300 rounded-lg' onChange={handleChange} checked={formData.regularPrice} />
                        ...
                        {formData.offer && (
                            <div className='flex items-center gap-2'>
                                <input type='number' id='discountprice' min='0' max='10000000' required className='p-3 border border-gray-300 rounded-lg' onChange={handleChange} checked={formData.discountPrice} />
                                <div className='flex flex-col items-center'>
